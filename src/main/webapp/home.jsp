...
out.write(
		"<a href=\"http://localhost:8080/zerobase-study21/load-wifi.jsp\" onclick=\"loading()\">Open API 와이파이 정보 가져오기</a>");
out.write("</div>");
out.write("<br>");
out.write("<div>");
...
out.write("<button onclick=\"showWifi()\">근처 WIFI 정보 보기</button>");
